...
print()
print("=" * 80)
print("A8 DE TERTIARY RULE VALIDATOR")
print("=" * 80)
...
print(f"Captured : {tp}/{de_total}")
print(f"Coverage : {100.0*tp/de_total:.2f}%")
...
print(f"Tertiary Hits  : {tertiary_hits}")
