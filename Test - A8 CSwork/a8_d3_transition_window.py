...
with open(CSV_FILE,newline="") as csvfile:
    ...
    for row in reader:
        ...
        if residual == 0x25:
            low_neg.append(frame)

        elif residual == 0xF6:
            mid_neg.append(frame)
...
def summarize(name, frames):
    ...
    for value,count in b4.most_common(10):
    ...
    for value,count in b6.most_common(10):
    ...
    for value,count in b7.most_common(15):
...
print()
print("=" * 60)
print("A8 D3 TRANSITION WINDOW")
print("=" * 60)

summarize("LOW_NEG (0x25)", low_neg)

summarize("MID_NEG (0xF6)", mid_neg)
