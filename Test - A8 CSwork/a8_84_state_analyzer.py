...
# ------------------------------------------------------------
# Copy directly from your V4 script
# ------------------------------------------------------------
...
with open(CSV_FILE,newline="") as csvfile:
    ...
    for row in reader:
        ...
        pair_counter[(actual,predicted)] += 1

# ------------------------------------------------------------

print()
print("="*80)
print("A8 0x84 STATE ANALYZER")
print("="*80)
...
for value,count in actual_counter.most_common():
...
for value,count in pred_counter.most_common():
...
for (actual,predicted),count in pair_counter.most_common():

    print(
        f"0x{actual:02X} -> 0x{predicted:02X} : {count}"
    )
...
for frame,rpm,stat,dyn,actual,predicted in rows[:30]:
