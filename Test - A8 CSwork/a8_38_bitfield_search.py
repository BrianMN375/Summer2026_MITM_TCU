...
print()
print("=" * 90)
print("A8 0x38 BITFIELD SEARCH")
print("=" * 90)

print()
print(f"0xBC Frames : {len(normal_frames):,}")
print(f"0x38 Frames : {len(overlay_frames):,}")
