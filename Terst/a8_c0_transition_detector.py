...
print()
print("=" * 80)
print("A8 C0 TRANSITION DETECTOR")
print("=" * 80)

for residual in [0x1E, 0xC0, 0x84]:

    rows = groups[residual]

    print()
    print("=" * 60)
    print(f"{TARGETS[residual]} (0x{residual:02X})")
    print("=" * 60)
...
# ------------------------------------------------------------
# Direct overlap analysis
# ------------------------------------------------------------

print()
print("=" * 80)
print("BYTE4 OWNERSHIP")
print("=" * 80)

ownership = {}

for residual, rows in groups.items():

    for frame, _, _, _ in rows:

        b4 = frame[4]

        if b4 not in ownership:
            ownership[b4] = Counter()

        ownership[b4][residual] += 1

for b4 in sorted(ownership):
