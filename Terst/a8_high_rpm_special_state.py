...
print()
print("=" * 80)
print("A8 HIGH RPM SPECIAL STATE ANALYSIS")
print("=" * 80)
...
for residual, rows in sorted(
    ...
    b4 = Counter(r[0][4] for r in rows)
    b6 = Counter(r[0][6] for r in rows)
    b7 = Counter(r[0][7] for r in rows)

    print()
    print("Top Byte4")
    print("---------")

    for v,c in b4.most_common(10):
