...
with open(CSV_FILE,newline="") as csvfile:
    ...
    for row in reader:
        ...
        if residual == 0x5E:
            low_pos.append(frame)

        elif residual == 0x8D:
            mid_pos.append(frame)

        #
        # D3 transition region:
        # RPM range observed in mismatch classifier
        #
...
def summarize(name, frames):
    ...
    for value,count in b4.most_common(15):

        print(f"0x{value:02X} {count:6d}")

    print()
    print("Top Byte6")
    print("---------")

    for value,count in b6.most_common(15):
    ...
    for value,count in b7.most_common(20):
...
print()
print("=" * 60)
print("A8 POSITIVE TRANSITION WINDOW")
print("=" * 60)

summarize("LOW_POS (0x5E)", low_pos)
summarize("MID_POS (0x8D)", mid_pos)
summarize("D3 TRANSITION POPULATION", d3_pop)
