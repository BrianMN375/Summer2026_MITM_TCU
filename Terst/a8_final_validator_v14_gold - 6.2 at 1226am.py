# Validation Results
#
# Frames analyzed : 59,406
# Correct         : 59,404
# Accuracy        : 99.9966%
#
# Remaining unexplained frames:
#
# IDX=37769
# ACT=B7 PRED=1E RES=A9
#
# IDX=37813
# ACT=87 PRED=1E RES=99
#
...
#   DYN=67
#
# Left intentionally unresolved to avoid overfitting.
...
# ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # B5 Overlay Ladder Candidate
    # ----------------------------------------------------------

    if byte5 in B5_OVERLAY_TABLE:
        ...
        if predicted in (
            ...
            predicted ^= B5_OVERLAY_TABLE[byte5]



    # ----------------------------------------------------------
    # Individual frame patches - singletons
    # ----------------------------------------------------------
